...
const RootLayout = () => {
    ...
    return (
        <div className='w-[100vw] h-[100vh] bg-white dark:bg-[#0a0a0a] dark:text-[#e2e8f0] select-none overflow-hidden relative p-[1vw] text-[#030712] flex gap-[.4vw] text-[1.1vw] max-md:text-[2vw] max-sm:text-[3vw] font-Montserrat'>
            <div ref={sidebarRef} className={`${modalData ? "left-0" : "left-[-50%]"} w-[20vw] dark:bg-[#131313] duration-500 max-md:w-[30vw] max-sm:w-[50vw] max-sm:fixed z-30 bg-white max-sm:bg-gray-50 flex flex-col gap-[.4vw]`}>
